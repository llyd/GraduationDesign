		...
		<tr v-for="academy in academys">
			  ...
			  <td v-bind:style="inputHidden"><input type="text" value="{{academy.classId}}"></td>
				...
				<td v-bind:style="tdShow">
					<button type="button" @click="editData(academy.id)" class="btn btn-success btn-xs" aria-label="change">修改</button>
				...
				<td v-bind:style="inputHidden">
					<button type="button" @click="changeData(academy.id)" class="btn btn-success btn-xs" aria-label="change">确定</button>
